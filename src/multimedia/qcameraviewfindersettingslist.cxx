...
extern "C" Q_DECL_EXPORT
void C_QCameraViewfinderSettingsList_swapItemsAt_0(void* this_ , int i, int j) {
    // QCameraViewfinderSettingsList_swapItemsAt_0()
     ((QCameraViewfinderSettingsList*)this_)->swapItemsAt(i, j);
}
