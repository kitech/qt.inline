...
// QCameraImageCapture is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qcameraimagecapture(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtMultimedia/qcameraimagecapture.h:62
// [8] QString tr(const char *, const char *, int) 
// (12)qm3605172031 (35)_ZN19QCameraImageCapture2trEPKcS1_i
//static
/*void qm3605172031(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QCameraImageCapture::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QCameraImageCapture::tr;
...
/*void C_ZN19QCameraImageCaptureD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qcameraimagecapture
//  main block end
