...
// QRadioData is pure virtual: false false
...
void* C_QRadioData_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQRadioData* qo = (MyQRadioData*)(this_);
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qradiodata(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtMultimedia/qradiodata.h:55
// [8] QString tr(const char *, const char *, int) 
// (12)qm3783554031 (26)_ZN10QRadioData2trEPKcS1_i
//static
/*void qm3783554031(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QRadioData::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QRadioData::tr;
...
/*void C_ZN10QRadioDataD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qradiodata
//  main block end
