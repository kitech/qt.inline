...
// QSyntaxHighlighter is pure virtual: true true
...
void* C_QSyntaxHighlighter_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQSyntaxHighlighter* qo = (MyQSyntaxHighlighter*)(this_);
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qsyntaxhighlighter(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtGui/qsyntaxhighlighter.h:62
// [8] QString tr(const char *, const char *, int) 
// (12)qm1692189702 (34)_ZN18QSyntaxHighlighter2trEPKcS1_i
//static
/*void qm1692189702(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QSyntaxHighlighter::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QSyntaxHighlighter::tr;
...
/*void C_ZN18QSyntaxHighlighterD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qsyntaxhighlighter
//  main block end
