...
extern "C" Q_DECL_EXPORT
void C_QAccessibleInterfaceList_swapItemsAt_0(void* this_ , int i, int j) {
    // QAccessibleInterfaceList_swapItemsAt_0()
     ((QAccessibleInterfaceList*)this_)->swapItemsAt(i, j);
}
