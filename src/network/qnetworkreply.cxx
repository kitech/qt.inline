...
// QNetworkReply is pure virtual: true true
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qnetworkreply(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtNetwork/qnetworkreply.h:64
// [8] QString tr(const char *, const char *, int) 
// (12)qm3083408823 (29)_ZN13QNetworkReply2trEPKcS1_i
//static
/*void qm3083408823(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QNetworkReply::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QNetworkReply::tr;
...
/*void C_ZN13QNetworkReplyD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qnetworkreply
//  main block end
