...
// QAbstractSocket is pure virtual: true false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qabstractsocket(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtNetwork/qabstractsocket.h:62
// [8] QString tr(const char *, const char *, int) 
// (12)qm4246853222 (31)_ZN15QAbstractSocket2trEPKcS1_i
//static
/*void qm4246853222(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QAbstractSocket::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QAbstractSocket::tr;
...
/*void C_ZN15QAbstractSocketD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qabstractsocket
//  main block end
