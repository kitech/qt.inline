...
// QNetworkAccessManager is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qnetworkaccessmanager(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtNetwork/qnetworkaccessmanager.h:76
// [8] QString tr(const char *, const char *, int) 
// (11)qm171273666 (37)_ZN21QNetworkAccessManager2trEPKcS1_i
//static
/*void qm171273666(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QNetworkAccessManager::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QNetworkAccessManager::tr;
...
/*void C_ZN21QNetworkAccessManagerD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qnetworkaccessmanager
//  main block end
