...
extern "C"
qint64 C_ZN10QUdpSocket13writeDatagramEPKcxRK12QHostAddresst(void *this_, const char * data, qint64 len, QHostAddress* host, quint16 port) {
  return (qint64)((QUdpSocket*)this_)->writeDatagram(data, len, *host, port);
}
