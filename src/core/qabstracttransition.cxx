...
// QAbstractTransition is pure virtual: true true
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qabstracttransition(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qabstracttransition.h:63
// [8] QString tr(const char *, const char *, int) 
// (12)qm2089563250 (35)_ZN19QAbstractTransition2trEPKcS1_i
//static
/*void qm2089563250(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QAbstractTransition::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QAbstractTransition::tr;
...
/*void C_ZN19QAbstractTransitionD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qabstracttransition
//  main block end
