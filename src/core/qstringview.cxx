...
struct qt_meta_stringdata_MyQStringView_t {
  QByteArrayData data[1];
  char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
  qptrdiff(offsetof(qt_meta_stringdata_MyQStringView_t, stringdata0) + ofs \
  - idx * sizeof(QByteArrayData)) \
  )
static const qt_meta_stringdata_MyQStringView_t qt_meta_stringdata_MyQStringView = {
   {
  QT_MOC_LITERAL(0, 0, 13), // "MyQStringView"
  },
  "MyQStringView"
};
#undef QT_MOC_LITERAL
static const uint qt_meta_data_MyQStringView[] = {
  // content:
  7,       // revision
  0,       // classname
  0,   0, // classinfo
