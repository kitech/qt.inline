...
// QSequentialAnimationGroup is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qsequentialanimationgroup(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qsequentialanimationgroup.h:54
// [8] QString tr(const char *, const char *, int) 
// (12)qm2444687306 (41)_ZN25QSequentialAnimationGroup2trEPKcS1_i
//static
/*void qm2444687306(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QSequentialAnimationGroup::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QSequentialAnimationGroup::tr;
...
/*void C_ZN25QSequentialAnimationGroupD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qsequentialanimationgroup
//  main block end
