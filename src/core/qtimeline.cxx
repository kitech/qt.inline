...
// QTimeLine is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qtimeline(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qtimeline.h:56
// [8] QString tr(const char *, const char *, int) 
// (11)qm429195558 (24)_ZN9QTimeLine2trEPKcS1_i
//static
/*void qm429195558(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QTimeLine::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QTimeLine::tr;
...
/*void C_ZN9QTimeLineD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qtimeline
//  main block end
