...
// QFileDevice is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qfiledevice(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qfiledevice.h:54
// [8] QString tr(const char *, const char *, int) 
// (12)qm2695535474 (27)_ZN11QFileDevice2trEPKcS1_i
//static
/*void qm2695535474(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QFileDevice::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QFileDevice::tr;
...
/*void C_ZN11QFileDeviceD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qfiledevice
//  main block end
