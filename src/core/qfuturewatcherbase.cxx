...
// QFutureWatcherBase is pure virtual: true true
...
// Private purevirtual virtual Direct Visibility=Default Availability=Available
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qfuturewatcherbase(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qfuturewatcher.h:56
// [8] QString tr(const char *, const char *, int) 
// (12)qm4286136955 (34)_ZN18QFutureWatcherBase2trEPKcS1_i
//static
/*void qm4286136955(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QFutureWatcherBase::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QFutureWatcherBase::tr;
...
/*void C_ZN18QFutureWatcherBaseD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qfuturewatcherbase
//  main block end
