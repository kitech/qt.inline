...
// QMimeData is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qmimedata(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qmimedata.h:54
// [8] QString tr(const char *, const char *, int) 
// (12)qm2769981123 (24)_ZN9QMimeData2trEPKcS1_i
//static
/*void qm2769981123(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QMimeData::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QMimeData::tr;
...
/*void C_ZN9QMimeDataD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qmimedata
//  main block end
