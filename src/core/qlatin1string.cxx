...
void* C_ZN13QLatin1StringC1EPKc(const char * s) {
  (MyQLatin1String*)(0);
  return  new MyQLatin1String(s);
}
// Public inline Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qstring.h:96
// [-2] void QLatin1String(const char *, const char *)
extern "C"
void* C_ZN13QLatin1StringC1EPKcS1_(const char * f, const char * l) {
  (MyQLatin1String*)(0);
  return  new MyQLatin1String(f, l);
}
// Public inline Visibility=Default Availability=Available
...
void* C_ZN13QLatin1StringC1EPKci(const char * s, int sz) {
  (MyQLatin1String*)(0);
  return  new MyQLatin1String(s, sz);
}
// Public inline Visibility=Default Availability=Available
