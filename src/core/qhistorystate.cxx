...
// QHistoryState is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qhistorystate(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qhistorystate.h:53
// [8] QString tr(const char *, const char *, int) 
// (12)qm4120431875 (29)_ZN13QHistoryState2trEPKcS1_i
//static
/*void qm4120431875(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QHistoryState::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QHistoryState::tr;
...
/*void C_ZN13QHistoryStateD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qhistorystate
//  main block end
