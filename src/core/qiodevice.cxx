...
extern "C"
qint64 C_ZN9QIODevice5writeERK10QByteArray(void *this_, const QByteArray & data) {
  return (qint64)((QIODevice*)this_)->write(data);
}
// Public Visibility=Default Availability=Available
