...
if (true) {
  auto f = [](QStringList flythis, const QRegularExpression & arg1, int arg2) {
    ((QStringList*)0)->lastIndexOf(arg1, arg2);
...
if (true) {
  auto f = [](QStringList flythis, const QString & arg1, Qt::CaseSensitivity arg2) {
    ((QStringList*)0)->contains(arg1, arg2);
...
if (true) {
  auto f = [](QStringList flythis, const QRegExp & arg1, int arg2) {
    ((QStringList*)0)->indexOf(arg1, arg2);
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, const QRegularExpression & arg1, const QString & arg2) {
    ((QListSpecialMethods<QString>*)0)->replaceInStrings(arg1, arg2);
    flythis.replaceInStrings(arg1, arg2);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, const QString & arg1, Qt::CaseSensitivity arg2) {
    ((QListSpecialMethods<QString>*)0)->filter(arg1, arg2);
    flythis.filter(arg1, arg2);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, Qt::CaseSensitivity arg1) {
    ((QListSpecialMethods<QString>*)0)->sort(arg1);
    flythis.sort(arg1);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, const QString & arg1, const QString & arg2, Qt::CaseSensitivity arg3) {
    ((QListSpecialMethods<QString>*)0)->replaceInStrings(arg1, arg2, arg3);
    flythis.replaceInStrings(arg1, arg2, arg3);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, const QString & arg1) {
    ((QListSpecialMethods<QString>*)0)->join(arg1);
    flythis.join(arg1);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis, const QRegularExpression & arg1) {
    ((QListSpecialMethods<QString>*)0)->filter(arg1);
    flythis.filter(arg1);
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QListSpecialMethods<QString> flythis) {
    ((QListSpecialMethods<QString>*)0)->removeDuplicates();
    flythis.removeDuplicates();
  };
  if (f == nullptr){}
}
...
extern "C"
int QListSpecialMethods_QString__Class_Size()
{
  return sizeof(QListSpecialMethods<QString>);
}
...
extern "C"
int
C_ZNK11QStringList11lastIndexOfERK18QRegularExpressioni(void *qthis,
const QRegularExpression* arg1,
int arg2) {
  auto ret =
  ((QStringList*)qthis)->lastIndexOf(*((const QRegularExpression*)arg1),
arg2);
...
extern "C"
bool
C_ZNK11QStringList8containsERK7QStringN2Qt15CaseSensitivityE(void *qthis,
const QString* arg1,
Qt::CaseSensitivity* arg2) {
  auto ret =
  ((QStringList*)qthis)->contains(*((const QString*)arg1),
*((Qt::CaseSensitivity*)arg2));
...
extern "C"
int
C_ZNK11QStringList7indexOfERK7QRegExpi(void *qthis,
const QRegExp* arg1,
int arg2) {
  auto ret =
...
extern "C"
int
C_ZNK11QStringList7indexOfER7QRegExpi(void *qthis,
QRegExp* arg1,
int arg2) {
  auto ret =
  ((QStringList*)qthis)->indexOf(*((QRegExp*)arg1),
arg2);
  return ret; // 0 TypeKind.INT
}
// <SourceLocation file '/usr/include/qt/QtCore/qstringlist.h', line 141, column 16>
...
extern "C"
int
C_ZNK11QStringList7indexOfERK18QRegularExpressioni(void *qthis,
const QRegularExpression* arg1,
int arg2) {
  auto ret =
  ((QStringList*)qthis)->indexOf(*((const QRegularExpression*)arg1),
arg2);
  return ret; // 0 TypeKind.INT
}
// <SourceLocation file '/usr/include/qt/QtCore/qstringlist.h', line 134, column 16>
...
extern "C"
int
C_ZNK11QStringList11lastIndexOfERK7QRegExpi(void *qthis,
const QRegExp* arg1,
int arg2) {
  auto ret =
  ((QStringList*)qthis)->lastIndexOf(*((const QRegExp*)arg1),
arg2);
  return ret; // 0 TypeKind.INT
}
// <SourceLocation file '/usr/include/qt/QtCore/qstringlist.h', line 136, column 16>
...
extern "C"
int
C_ZNK11QStringList11lastIndexOfER7QRegExpi(void *qthis,
QRegExp* arg1,
int arg2) {
  auto ret =
...
extern "C"
QStringList*
C_ZN19QListSpecialMethodsI7QStringE16replaceInStringsERK18QRegularExpressionRKS0_(void *qthis,
const QRegularExpression* arg1,
const QString* arg2) {
  auto& ret =
  ((QListSpecialMethods<QString>*)qthis)->replaceInStrings(*((const QRegularExpression*)arg1),
*((const QString*)arg2));
...
extern "C"
QStringList*
C_ZNK19QListSpecialMethodsI7QStringE6filterERKS0_N2Qt15CaseSensitivityE(void *qthis,
const QString* arg1,
Qt::CaseSensitivity* arg2) {
  auto ret =
  ((QListSpecialMethods<QString>*)qthis)->filter(*((const QString*)arg1),
*((Qt::CaseSensitivity*)arg2));
  return new QStringList(ret); // 5
}
// <SourceLocation file '/usr/include/qt/QtCore/qstringlist.h', line 72, column 17>
...
extern "C"
void
C_ZN19QListSpecialMethodsI7QStringE4sortEN2Qt15CaseSensitivityE(void *qthis,
...
extern "C"
QStringList*
C_ZN19QListSpecialMethodsI7QStringE16replaceInStringsERKS0_S3_N2Qt15CaseSensitivityE(void *qthis,
const QString* arg1,
const QString* arg2,
Qt::CaseSensitivity* arg3) {
  auto& ret =
  ((QListSpecialMethods<QString>*)qthis)->replaceInStrings(*((const QString*)arg1),
*((const QString*)arg2),
*((Qt::CaseSensitivity*)arg3));
  return new QStringList(ret); // 5
}
...
extern "C"
QString*
C_ZNK19QListSpecialMethodsI7QStringE4joinERKS0_(void *qthis,
const QString* arg1) {
  auto ret =
...
extern "C"
QStringList*
C_ZNK19QListSpecialMethodsI7QStringE6filterERK18QRegularExpression(void *qthis,
const QRegularExpression* arg1) {
  auto ret =
...
extern "C"
int
C_ZN19QListSpecialMethodsI7QStringE16removeDuplicatesEv(void *qthis) {
  auto ret =
...
extern "C"
QStringList*
C_ZN19QListSpecialMethodsI7QStringE16replaceInStringsERK7QRegExpRKS0_(void *qthis,
const QRegExp* arg1,
const QString* arg2) {
  auto& ret =
  ((QListSpecialMethods<QString>*)qthis)->replaceInStrings(*((const QRegExp*)arg1),
*((const QString*)arg2));
  return new QStringList(ret); // 5
}
// <SourceLocation file '/usr/include/qt/QtCore/qstringlist.h', line 82, column 24>
...
extern "C"
QStringList*
C_ZNK19QListSpecialMethodsI7QStringE6filterERK7QRegExp(void *qthis,
const QRegExp* arg1) {
  auto ret =
...
extern "C"
QString*
C_ZNK19QListSpecialMethodsI7QStringE4joinE5QChar(void *qthis,
QChar* arg1) {
  auto ret =
  ((QListSpecialMethods<QString>*)qthis)->join(*((QChar*)arg1));
  return new QString(ret); // 5
}
// <= ext block end
