...
int _ZNK11QStringList11lastIndexOfERK18QRegularExpressioni(void *that, const QRegularExpression & re, int from)
{
...
bool _ZNK11QStringList8containsERK7QStringN2Qt15CaseSensitivityE(void *that, const QString & str, Qt::CaseSensitivity cs)
{
  QStringList *cthat = (QStringList *)that;
