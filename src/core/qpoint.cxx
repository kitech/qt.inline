...
if (true) {
  auto f = [](QPoint flythis) {
    ((QPoint*)0)->manhattanLength();
    flythis.manhattanLength();
  };
  if (f == nullptr){}
}
...
if (true) {
  auto f = [](QPointF flythis, const QPointF & arg1, const QPointF & arg2) {
    ((QPointF*)0)->dotProduct(arg1, arg2);
    flythis.dotProduct(arg1, arg2);
  };
  if (f == nullptr){}
}
...
extern "C"
int
C_ZN6QPoint10dotProductERKS_S1_(const QPoint* arg1,
const QPoint* arg2) {
  auto ret =
  QPoint::dotProduct(*((const QPoint*)arg1),
*((const QPoint*)arg2));
  return ret; // 0 TypeKind.INT
}
// <SourceLocation file '/usr/include/qt/QtCore/qpoint.h', line 56, column 33>
...
extern "C"
bool
C_ZNK6QPoint6isNullEv(void *qthis) {
  auto ret =
  ((QPoint*)qthis)->isNull();
...
extern "C"
int
C_ZNK6QPoint15manhattanLengthEv(void *qthis) {
  auto ret =
...
extern "C"
double
C_ZNK7QPointF15manhattanLengthEv(void *qthis) {
  auto ret =
...
extern "C"
QPoint*
C_ZNK7QPointF7toPointEv(void *qthis) {
  auto ret =
...
extern "C"
bool
C_ZNK7QPointF6isNullEv(void *qthis) {
  auto ret =
...
extern "C"
void
C_ZN7QPointF4setXEd(void *qthis,
qreal arg1) {
...
extern "C"
double
C_ZN7QPointF10dotProductERKS_S1_(const QPointF* arg1,
const QPointF* arg2) {
  auto ret =
  QPointF::dotProduct(*((const QPointF*)arg1),
*((const QPointF*)arg2));
  return ret; // 0 TypeKind.DOUBLE
}
// <SourceLocation file '/usr/include/qt/QtCore/qpoint.h', line 225, column 42>
...
extern "C"
void
C_ZN7QPointF4setYEd(void *qthis,
qreal arg1) {
  ((QPointF*)qthis)->setY(arg1);
}
// <= ext block end
