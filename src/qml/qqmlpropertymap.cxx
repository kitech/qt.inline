...
// QQmlPropertyMap is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qqmlpropertymap(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtQml/qqmlpropertymap.h:56
// [8] QString tr(const char *, const char *, int) 
// (12)qm1308612287 (31)_ZN15QQmlPropertyMap2trEPKcS1_i
//static
/*void qm1308612287(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QQmlPropertyMap::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QQmlPropertyMap::tr;
...
/*void C_ZN15QQmlPropertyMapD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qqmlpropertymap
//  main block end
