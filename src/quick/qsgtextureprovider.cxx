...
// QSGTextureProvider is pure virtual: true true
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qsgtextureprovider(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtQuick/qsgtextureprovider.h:50
// [8] QString tr(const char *, const char *, int) 
// (12)qm2080066529 (34)_ZN18QSGTextureProvider2trEPKcS1_i
//static
/*void qm2080066529(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QSGTextureProvider::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QSGTextureProvider::tr;
...
/*void C_ZN18QSGTextureProviderD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qsgtextureprovider
//  main block end
