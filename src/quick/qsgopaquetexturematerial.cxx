...
struct qt_meta_stringdata_MyQSGOpaqueTextureMaterial_t {
  QByteArrayData data[1];
  char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
  qptrdiff(offsetof(qt_meta_stringdata_MyQSGOpaqueTextureMaterial_t, stringdata0) + ofs \
  - idx * sizeof(QByteArrayData)) \
  )
static const qt_meta_stringdata_MyQSGOpaqueTextureMaterial_t qt_meta_stringdata_MyQSGOpaqueTextureMaterial = {
   {
  QT_MOC_LITERAL(0, 0, 26), // "MyQSGOpaqueTextureMaterial"
  },
  "MyQSGOpaqueTextureMaterial"
};
#undef QT_MOC_LITERAL
static const uint qt_meta_data_MyQSGOpaqueTextureMaterial[] = {
  // content:
  7,       // revision
  0,       // classname
  0,   0, // classinfo
