...
// QSvgWidget is pure virtual: false false
...
void* C_QSvgWidget_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQSvgWidget* qo = (MyQSvgWidget*)(this_);
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qsvgwidget(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtSvg/qsvgwidget.h:60
// [8] QString tr(const char *, const char *, int) 
// (12)qm2440269796 (26)_ZN10QSvgWidget2trEPKcS1_i
//static
/*void qm2440269796(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QSvgWidget::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QSvgWidget::tr;
...
/*void C_ZN10QSvgWidgetD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qsvgwidget
//  main block end
