...
// QLineEdit is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qlineedit(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qlineedit.h:65
// [8] QString tr(const char *, const char *, int) 
// (12)qm2074787026 (24)_ZN9QLineEdit2trEPKcS1_i
//static
/*void qm2074787026(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QLineEdit::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QLineEdit::tr;
...
/*void C_ZN9QLineEditD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qlineedit
//  main block end
