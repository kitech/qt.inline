...
struct qt_meta_stringdata_MyQStylePlugin_t {
  QByteArrayData data[1];
  char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
  qptrdiff(offsetof(qt_meta_stringdata_MyQStylePlugin_t, stringdata0) + ofs \
  - idx * sizeof(QByteArrayData)) \
  )
static const qt_meta_stringdata_MyQStylePlugin_t qt_meta_stringdata_MyQStylePlugin = {
   {
  QT_MOC_LITERAL(0, 0, 14), // "MyQStylePlugin"
  },
  "MyQStylePlugin"
};
#undef QT_MOC_LITERAL
static const uint qt_meta_data_MyQStylePlugin[] = {
  // content:
  7,       // revision
  0,       // classname
  0,   0, // classinfo
...
public: // Q_OBJECT
/*static*/ QMetaObject staticMetaObject = {{&QStylePlugin::staticMetaObject,
  qt_meta_stringdata_MyQStylePlugin.data,
  qt_meta_data_MyQStylePlugin,
...
virtual void *qt_metacast(const char *_clname) override {
  ...
  if (!strcmp(_clname, qt_meta_stringdata_MyQStylePlugin.stringdata0))
...
void* C_QStylePlugin_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQStylePlugin* qo = (MyQStylePlugin*)(this_);
