...
// QMenuBar is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qmenubar(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qmenubar.h:57
// [8] QString tr(const char *, const char *, int) 
// (11)qm963358739 (23)_ZN8QMenuBar2trEPKcS1_i
//static
/*void qm963358739(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QMenuBar::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QMenuBar::tr;
...
/*void C_ZN8QMenuBarD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qmenubar
//  main block end
