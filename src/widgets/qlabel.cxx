...
// QLabel is pure virtual: false false
...
void* C_QLabel_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQLabel* qo = (MyQLabel*)(this_);
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qlabel(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qlabel.h:55
// [8] QString tr(const char *, const char *, int) 
// (11)qm633654009 (21)_ZN6QLabel2trEPKcS1_i
//static
/*void qm633654009(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QLabel::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QLabel::tr;
...
/*void C_ZN6QLabelD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qlabel
//  main block end
