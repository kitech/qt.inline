...
// QKeySequenceEdit is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qkeysequenceedit(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qkeysequenceedit.h:54
// [8] QString tr(const char *, const char *, int) 
// (12)qm1020688000 (32)_ZN16QKeySequenceEdit2trEPKcS1_i
//static
/*void qm1020688000(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QKeySequenceEdit::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QKeySequenceEdit::tr;
...
/*void C_ZN16QKeySequenceEditD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qkeysequenceedit
//  main block end
