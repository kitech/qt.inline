...
// QScrollBar is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qscrollbar(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qscrollbar.h:57
// [8] QString tr(const char *, const char *, int) 
// (12)qm2056464608 (26)_ZN10QScrollBar2trEPKcS1_i
//static
/*void qm2056464608(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QScrollBar::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QScrollBar::tr;
...
/*void C_ZN10QScrollBarD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qscrollbar
//  main block end
