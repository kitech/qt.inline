...
qreal _ZNK19QGraphicsLayoutItem12minimumWidthEv(void *that)
{
...
qreal _ZNK19QGraphicsLayoutItem14preferredWidthEv(void *that)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
qreal _ZNK19QGraphicsLayoutItem13minimumHeightEv(void *that)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
qreal _ZNK19QGraphicsLayoutItem15preferredHeightEv(void *that)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
qreal _ZNK19QGraphicsLayoutItem13maximumHeightEv(void *that)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
qreal _ZNK19QGraphicsLayoutItem12maximumWidthEv(void *that)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
void _ZN19QGraphicsLayoutItem14setMinimumSizeEdd(void *that, double w, double h)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
void _ZN19QGraphicsLayoutItem16setPreferredSizeEdd(void *that, double w, double h)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
...
void _ZN19QGraphicsLayoutItem14setMaximumSizeEdd(void *that, double w, double h)
{
  QGraphicsLayoutItem *cthat = (QGraphicsLayoutItem *)that;
