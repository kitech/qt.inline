...
struct qt_meta_stringdata_MyQPanGesture_t {
  QByteArrayData data[1];
  char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
  qptrdiff(offsetof(qt_meta_stringdata_MyQPanGesture_t, stringdata0) + ofs \
  - idx * sizeof(QByteArrayData)) \
  )
static const qt_meta_stringdata_MyQPanGesture_t qt_meta_stringdata_MyQPanGesture = {
   {
  QT_MOC_LITERAL(0, 0, 13), // "MyQPanGesture"
  },
  "MyQPanGesture"
};
#undef QT_MOC_LITERAL
static const uint qt_meta_data_MyQPanGesture[] = {
  // content:
  7,       // revision
  0,       // classname
  0,   0, // classinfo
...
public: // Q_OBJECT
/*static*/ QMetaObject staticMetaObject = {{&QPanGesture::staticMetaObject,
  qt_meta_stringdata_MyQPanGesture.data,
  qt_meta_data_MyQPanGesture,
...
virtual void *qt_metacast(const char *_clname) override {
  ...
  if (!strcmp(_clname, qt_meta_stringdata_MyQPanGesture.stringdata0))
...
void* C_QPanGesture_init_staticMetaObject(void* this_, void* strdat, void* dat, void* smcfn, void* mcastfn, void* mcallfn) {
  MyQPanGesture* qo = (MyQPanGesture*)(this_);
