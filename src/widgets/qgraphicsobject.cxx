...
// QGraphicsObject is pure virtual: false true
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qgraphicsobject(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qgraphicsitem.h:550
// [8] QString tr(const char *, const char *, int) 
// (11)qm972876590 (31)_ZN15QGraphicsObject2trEPKcS1_i
//static
/*void qm972876590(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QGraphicsObject::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QGraphicsObject::tr;
...
/*void C_ZN15QGraphicsObjectD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qgraphicsobject
//  main block end
