...
// QStackedWidget is pure virtual: false false
...
extern "C" // Q_DECL_EXPORT
uint64_t ensure_inline_symbol_qstackedwidget(void* this_) {
  uint64_t fnptrsumval = 0;

// Public static inline Indirect Visibility=Default Availability=Available
// /usr/include/qt/QtWidgets/qstackedwidget.h:54
// [8] QString tr(const char *, const char *, int) 
// (12)qm4110966685 (30)_ZN14QStackedWidget2trEPKcS1_i
//static
/*void qm4110966685(const char * s, const char * c, int n)*/ {
  const char * s = *(const char **)this_; const char * c = *(const char **)this_; int n = *(int*)this_;
  (void) QStackedWidget::tr(s, c, n);
   auto xptr = (QString (*)(char const*, char const*, int) ) &QStackedWidget::tr;
...
/*void C_ZN14QStackedWidgetD2Ev(void *this_)*/ {
  ...
  return fnptrsumval;
} // end ensure_inline_symbol_qstackedwidget
//  main block end
