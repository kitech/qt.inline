...
extern "C"
void C_Z17qDrawBorderPixmapP8QPainterRK5QRectRK8QMarginsRK7QPixmapS3_S6_RK10QTileRules6QFlagsIN17QDrawBorderPixmap11DrawingHintEE(QPainter * painter, const QRect & targetRect, const QMargins & targetMargins, const QPixmap & pixmap, const QRect & sourceRect, const QMargins & sourceMargins, const QTileRules & rules, QFlags<QDrawBorderPixmap::DrawingHint> hints) {
...
extern "C"
void C_Z17qDrawBorderPixmapP8QPainterRK5QRectRK8QMarginsRK7QPixmap_1(QPainter * painter, const QRect & target, const QMargins & margins, const QPixmap & pixmap) {
...
extern "C"
void C_Z15qDrawShadePanelP8QPainteriiiiRK8QPalettebiPK6QBrush(QPainter * p, int x, int y, int w, int h, const QPalette & pal, bool sunken, int lineWidth, const QBrush * fill) {
...
extern "C"
void C_Z15qDrawShadePanelP8QPainterRK5QRectRK8QPalettebiPK6QBrush_1(QPainter * p, const QRect & r, const QPalette & pal, bool sunken, int lineWidth, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawWinButtonP8QPainteriiiiRK8QPalettebPK6QBrush(QPainter * p, int x, int y, int w, int h, const QPalette & pal, bool sunken, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawWinButtonP8QPainterRK5QRectRK8QPalettebPK6QBrush_1(QPainter * p, const QRect & r, const QPalette & pal, bool sunken, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawShadeRectP8QPainteriiiiRK8QPalettebiiPK6QBrush(QPainter * p, int x, int y, int w, int h, const QPalette & pal, bool sunken, int lineWidth, int midLineWidth, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawShadeRectP8QPainterRK5QRectRK8QPalettebiiPK6QBrush_1(QPainter * p, const QRect & r, const QPalette & pal, bool sunken, int lineWidth, int midLineWidth, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawShadeLineP8QPainteriiiiRK8QPalettebii(QPainter * p, int x1, int y1, int x2, int y2, const QPalette & pal, bool sunken, int lineWidth, int midLineWidth) {
...
extern "C"
void C_Z14qDrawShadeLineP8QPainterRK6QPointS3_RK8QPalettebii_1(QPainter * p, const QPoint & p1, const QPoint & p2, const QPalette & pal, bool sunken, int lineWidth, int midLineWidth) {
...
extern "C"
void C_Z14qDrawPlainRectP8QPainteriiiiRK6QColoriPK6QBrush(QPainter * p, int x, int y, int w, int h, const QColor & arg5, int lineWidth, const QBrush * fill) {
...
extern "C"
void C_Z14qDrawPlainRectP8QPainterRK5QRectRK6QColoriPK6QBrush_1(QPainter * p, const QRect & r, const QColor & arg2, int lineWidth, const QBrush * fill) {
...
extern "C"
void C_Z13qDrawWinPanelP8QPainteriiiiRK8QPalettebPK6QBrush(QPainter * p, int x, int y, int w, int h, const QPalette & pal, bool sunken, const QBrush * fill) {
...
extern "C"
void C_Z13qDrawWinPanelP8QPainterRK5QRectRK8QPalettebPK6QBrush_1(QPainter * p, const QRect & r, const QPalette & pal, bool sunken, const QBrush * fill) {
